...
const BOSSES: Record<string, BossConfig> = {
  ...
  mechanics: {
    variant: "generic",
    name: "Reazione",
    epithet: "Lord of Constraints",
    intro: "Every degree of freedom you forget, it takes. Draw the free-body diagram or be pinned by it.",
    taunts: [
      "You forgot a reaction force. I never do.",
      "Your mechanism is over-constrained. Like your thinking.",
      "Static? Dynamic? You cannot even tell.",
    ],
    hurts: ["My equilibrium… broken!", "You freed a constraint?!", "Impossible — the diagram was MINE!"],
    colors: { primary: 0xd15b2f, secondary: 0xe6a23f, glow: 0xff8a3d },
  },
  cybersecurity: {
    variant: "generic",
    name: "Zero-Day",
    epithet: "The Unpatched One",
    intro: "It lives in the gap between disclosure and patch. Authenticate yourself — with correct answers.",
    taunts: [
      "Access denied. Try again, script kiddie.",
      "Your threat model forgot… me.",
      "I already exfiltrated your grade.",
    ],
    hurts: ["Patched?!", "My CVE… published!", "You rotated the keys?!"],
    colors: { primary: 0x27ae60, secondary: 0x145a32, glow: 0x2ecc71 },
  },
  "electronic-systems": {
    variant: "generic",
    name: "Ohmega",
    epithet: "Master of the Rail-to-Rail",
    intro: "It saturates every op-amp you idealize. Keep your feedback negative and your answers exact.",
    taunts: [
      "Your op-amp is saturated. So is my patience.",
      "That pole was in your right half-plane.",
      "Gain without bandwidth. Typical student.",
    ],
    hurts: ["My feedback… positive?!", "Clipped!", "You matched the impedance?!"],
    colors: { primary: 0x2f8cff, secondary: 0x0f9f8f, glow: 0x45a4ff },
  },
  "fundamentals-electronic-systems": {
    variant: "generic",
    name: "Il Circuito Aperto",
    epithet: "Breaker of Loops",
    intro: "Somewhere in this mesh, a node is lying to you. Sum your currents. Trust Kirchhoff.",
    taunts: [
      "Your KCL leaks current somewhere.",
      "Phasors spin. You just spin.",
      "That ground was not where you think.",
    ],
    hurts: ["The loop… closes!", "My mesh… solved?!", "Kirchhoff forgives you. I do not."],
    colors: { primary: 0x0f9f8f, secondary: 0x2f8cff, glow: 0x37c2a8 },
  },
  "linear-algebra": {
    variant: "generic",
